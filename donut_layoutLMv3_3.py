...
class LayoutLMEncoder(nn.Module):
    ...
    def prepare_input(self, img: PIL.Image.Image, tokens: List[str], bboxes: List[List[int]]):
        return self.processor(img, tokens, boxes=bboxes, max_length=self.max_length, padding="max_length", return_tensors="pt", truncation=True)
...
class DonutModel(PreTrainedModel):
    ...
    def __init__(self, config: DonutConfig):
        ...
        self.decoder = BARTDecoder(
            ...
            add_vocab_list=self.config.add_vocab_list,
        )
    ...
    def inference(
        ...
        decoder_output = self.decoder.model.generate(
            ...
            encoder_attention_mask=inputs["attention_mask"] if "attention_mask" in inputs.keys() else None,
